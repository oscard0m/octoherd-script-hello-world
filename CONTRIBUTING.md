...
1. Please make sure there is no [open issue](https://github.com/oscard0m/octoherd-script-hello-world/issues?utf8=%E2%9C%93&q=is%3Aissue) yet.
...
```shell
git clone https://github.com/<your account name>/octoherd-script-hello-world.git
cd octoherd-script-hello-world
npm install
```
...
- Submit a pull request from your topic branch to the main branch on the `oscard0m/octoherd-script-hello-world` repository.
